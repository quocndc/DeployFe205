...
export const SearchSubCategory: React.FC<ChildProps> = ({ data, isLoading, onSelection, defaultValue, clear }) => {
  ...
  const renderitem = React.useMemo(() => {
    ...
    return data.map((framework) => (
      ...
      >
        ...
        {framework.label} {/* Hiển thị tên thay vì ID */}
      </CommandItem>
    ))
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {value ? data.find((framework) => framework.value === value)?.label : ''} {/* Hiển thị tên thay vì ID */}
